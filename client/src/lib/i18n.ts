...
export const translations = {
  en: {
    ...
    totalTaxThisPeriod: 'Total Tax This Period',
    vatThisPeriod: 'VAT This Period',
    businessPITThisPeriod: 'PIT This Period',
    voluntaryInsuranceThisPeriod: 'Voluntary Insurance This Period',
    netAfterVoluntary: 'Net After Voluntary Insurance',

    // Voluntary insurance
    voluntaryInsuranceTitle: 'Voluntary Insurance',
    voluntaryInsuranceDescription: 'Freelancers can opt into voluntary BHXH (Social Insurance) and household BHYT (Health Insurance). BHTN (Unemployment) is NOT available voluntarily — it only applies to those under labor contracts ≥ 1 month per the 2025 Employment Law.',
    voluntaryBhxhEnabled: 'Voluntary BHXH (Social Insurance, 22%)',
    voluntaryBhxhBase: 'BHXH Contribution Base (Monthly)',
    voluntaryBhxhBaseHint: 'Min ₫1,500,000 / Max ₫46,800,000 (20× reference level). Covers retirement, survivorship, maternity, occupational accident.',
    voluntaryBhytEnabled: 'Voluntary BHYT Household (4.5%)',
    voluntaryBhytHint: '4.5% × ₫2,340,000 reference level = ₫105,300/month (single member).',
    bhtnNotAvailable: 'BHTN (Unemployment Insurance) is not available voluntarily — by law, only employees under labor contracts ≥ 1 month can participate.',
  ...
  vi: {
    ...
    netThisPeriod: 'Thực Nhận Trong Kỳ',
    revenueThisPeriod: 'Doanh Thu Trong Kỳ',
    totalTaxThisPeriod: 'Tổng Thuế Trong Kỳ',
    vatThisPeriod: 'VAT Trong Kỳ',
    businessPITThisPeriod: 'TNCN Trong Kỳ',
    voluntaryInsuranceThisPeriod: 'Bảo Hiểm Tự Nguyện Trong Kỳ',
    netAfterVoluntary: 'Thực Nhận Sau Bảo Hiểm Tự Nguyện',

    // Voluntary insurance
    voluntaryInsuranceTitle: 'Bảo Hiểm Tự Nguyện',
    voluntaryInsuranceDescription: 'Freelancer có thể tham gia BHXH tự nguyện và BHYT hộ gia đình. BHTN KHÔNG có tự nguyện — theo Luật Việc làm 2025, chỉ áp dụng cho người có HĐLĐ ≥ 1 tháng.',
    voluntaryBhxhEnabled: 'BHXH Tự Nguyện (22%)',
    voluntaryBhxhBase: 'Mức Đóng BHXH (Hàng Tháng)',
    voluntaryBhxhBaseHint: 'Tối thiểu ₫1.500.000 / Tối đa ₫46.800.000 (20 lần mức tham chiếu). Bao gồm hưu trí, tử tuất, thai sản, tai nạn lao động.',
    voluntaryBhytEnabled: 'BHYT Hộ Gia Đình (4.5%)',
    voluntaryBhytHint: '4.5% × ₫2.340.000 mức tham chiếu = ₫105.300/tháng (1 thành viên).',
    bhtnNotAvailable: 'BHTN không có tự nguyện — theo luật, chỉ người lao động có HĐLĐ ≥ 1 tháng mới được tham gia.',
